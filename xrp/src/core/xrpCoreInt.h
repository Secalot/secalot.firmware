...
#define XRP_CORE_TRANSACTION_READ_NUMBER_OF_CHUNKS (XRP_CORE_MAX_VIEWABLE_TRANSACTION_SIZE/XRP_CORE_TRANSACTION_READ_CHUNK_SIZE)
...
#define XRP_CORE_P1P2_SETUP (0x0000)
