...
int mbedtls_rsa_check_privkey( const mbedtls_rsa_context *ctx )
{
    ...
    MBEDTLS_MPI_CHK( mbedtls_mpi_mul_mpi_soft( &DE, &ctx->D, &ctx->E ) );
#else /* MBEDTLS_LCT_RSA_FIX */
...
#ifdef MBEDTLS_LCT_RSA_FIX
    MBEDTLS_MPI_CHK( mbedtls_mpi_div_mpi_soft( &L1, &L2, &H, &G2 ) );
    MBEDTLS_MPI_CHK( mbedtls_mpi_mod_mpi_soft( &I, &DE, &L1  ) );
#else /* MBEDTLS_LCT_RSA_FIX */
...
#ifdef MBEDTLS_LCT_RSA_FIX
        MBEDTLS_MPI_CHK( mbedtls_mpi_mul_mod_mpi( &ctx->Vi, &ctx->Vi, &ctx->Vi, &ctx->N) );
        MBEDTLS_MPI_CHK( mbedtls_mpi_mul_mod_mpi( &ctx->Vf, &ctx->Vf, &ctx->Vf, &ctx->N) );
#else /* MBEDTLS_LCT_RSA_FIX */
...
#ifdef MBEDTLS_LCT_RSA_FIX
        MBEDTLS_MPI_CHK( mbedtls_mpi_mul_mod_mpi( &T, &T, &ctx->Vi, &ctx->N) );
#else /* MBEDTLS_LCT_RSA_FIX */
...
#ifdef MBEDTLS_LCT_RSA_FIX
        MBEDTLS_MPI_CHK( mbedtls_mpi_mul_mod_mpi( &T, &T, &ctx->Vf, &ctx->N) );
#else /* MBEDTLS_LCT_RSA_FIX */
