...
uint8_t privateKeyTemplate[] = {
    0x30, 0x77, 0x02, 0x01, 0x01, 0x04, 0x20, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xA0, 0x0A, 0x06, 0x08, 0x2A, 0x86, 0x48, 0xCE, 0x3D, 0x03, 0x01, 0x07, 0xA1, 0x44, 0x03,
    0x42, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};

uint8_t certificateTemplate[] = {
    ,
...
static void mk82SslGetPrivateKey(uint8_t* privateKey)
{
    ...
    mk82FsReadFile(MK82_FS_FILE_ID_SSL_KEYS, offsetof(SSL_NVM_KEYS, privateKey), encryptedPrivateKey,
    ...
    calleeRetVal = mk82KeysafeUnwrapKey(MK82_KEYSAFE_CCR_KEK_ID, encryptedPrivateKey, sizeof(encryptedPrivateKey),
                                        privateKey, NULL, 0, nonce, tag);
...
static void mk82SllCheckPrivateKeyPresense(void)
{
    ...
    if (keyInitialized != MK82_TRUE)
    {
        ...
        mk82KeysafeWrapKey(MK82_KEYSAFE_CCR_KEK_ID, privateKey, sizeof(privateKey), encryptedPrivateKey, NULL, 0, nonce,
                           tag);
        ...
        mk82FsWriteFile(MK82_FS_FILE_ID_SSL_KEYS, offsetof(SSL_NVM_KEYS, publicKey), publicKey,
                        MK82_SSL_PUBLIC_KEY_LENGTH);
        mk82FsWriteFile(MK82_FS_FILE_ID_SSL_KEYS, offsetof(SSL_NVM_KEYS, privateKey), encryptedPrivateKey,
                        MK82_SSL_PRIVATE_KEY_LENGTH);
        mk82FsWriteFile(MK82_FS_FILE_ID_SSL_KEYS, offsetof(SSL_NVM_KEYS, privateKeyNonce), nonce,
                        MK82_SSL_NONCE_LENGTH);
...
void mk82SslInit(void)
{
    ...
    ret =
        mbedtls_pk_parse_key(&mk82SslPkContext, (const unsigned char*)privateKeyBlob, sizeof(privateKeyBlob), NULL, 0);
    ...
    ret = mbedtls_ssl_config_defaults(&mk82SslConfig, MBEDTLS_SSL_IS_SERVER, MBEDTLS_SSL_TRANSPORT_STREAM,
...
void mk82SslWrapAPDUResponse(uint8_t* apdu, uint32_t* apduLength)
{
    ...
    {
        calleeRetVal =
            mbedtls_ssl_write(&mk82SslContext, responseAPDU.data + bytesProcessed, apduResponseLength - bytesProcessed);
...
void mk82SslWipeout(void)
{
    ...
    {
        mk82FsWriteFile(MK82_FS_FILE_ID_SSL_KEYS, bytesWritten, wipeoutBuffer, (sizeof(SSL_NVM_KEYS) - bytesWritten));
    }
